# Signal of the Flashes
* **Description** There has been strange signals broadcasting from 89.7 WKSU-FM. Might there could be a hidden message within it? NOTE: Your input should be khi{[decrypted_text]} all lowercase.
